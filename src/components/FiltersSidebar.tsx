    ...
    <aside className="flex flex-col gap-6 rounded-2xl border border-[var(--border)] bg-[var(--panel)] p-5 shadow-[0_12px_30px_rgba(0,0,0,0.35)] backdrop-blur h-fit sticky top-6 animate-sidebar-enter">
      ...
      <div className="flex flex-col gap-3 border-t border-[var(--border)] pt-4">
        <div className="flex items-center justify-between">
          <label htmlFor="relevance-slider" className="text-sm font-medium text-[var(--text-primary)]">
            Minimum Match
          </label>
      ...
      {/* Skills Filter */}
      <div className="flex flex-col gap-3 border-t border-[var(--border)] pt-4">
        <h4 className="text-sm font-medium text-[var(--text-primary)] mb-1">Required Skills</h4>
              ...
              <label 
                ...
                className={clsx(
                  ...
                  isSelected 
                    ...
                    : "border-[var(--border)] bg-[var(--panel-alt)] text-[var(--text-secondary)] hover:bg-[var(--btn-bg)] hover:text-[var(--text-primary)]"
                )}
              >
      ...
      <div className="pt-2 border-t border-[var(--border)]">
        <button
          ...
          className="w-full rounded-xl bg-[var(--btn-bg)] border border-[var(--border)] px-4 py-2.5 text-sm font-semibold text-[var(--text-secondary)] transition hover:bg-[var(--btn-hover)] hover:text-[var(--text-primary)] disabled:cursor-not-allowed disabled:opacity-50"
        >
